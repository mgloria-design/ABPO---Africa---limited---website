...
<title>BPO & Managed Services | ABPO Africa Limited</title>
<meta name="description" content="ABPO Africa Limited's BPO & Managed Services — finance and accounting outsourcing, contact center support, HR and payroll administration, and IT managed services for organizations in Nairobi, Kenya and across Africa.">
...
<section class="hero hero-flat" id="page-top">
    <div class="hero-content fade-in">
        ...
        <p>
            We take on the operational functions that keep your business running
            but aren't core to what makes it different — so your team can spend
            its time on the work only they can do.
        </p>
    ...
    <div class="about-container">
        ...
        <div class="about-grid">
            ...
            <div class="about-info fade-in">
                ...
                <h3>
                    Taking Operational Work
                    Off Your Plate
                </h3>

                <p>
                    Every organization carries functions that have to run
                    reliably but don't need to be run in-house — finance
                    processing, customer support, payroll, IT helpdesk and more.
                    We take these on as managed services, with clear scopes and
                    service levels, so they run consistently without pulling your
                    team's attention away from the work that actually differentiates
                    your business.
                </p>
            ...
            <div class="about-panel fade-in">
                ...
                <ul>
                    <li><i class="fas fa-check" aria-hidden="true"></i> Your team is stretched thin covering back-office functions.</li>
                    <li><i class="fas fa-check" aria-hidden="true"></i> Hiring and training in-house staff for non-core work is proving costly.</li>
                    <li><i class="fas fa-check" aria-hidden="true"></i> Work volumes fluctuate and your current staffing can't flex with them.</li>
                    <li><i class="fas fa-check" aria-hidden="true"></i> There's no consistent service level for support functions today.</li>
                    <li><i class="fas fa-check" aria-hidden="true"></i> Leadership's time is going to operations instead of strategic priorities.</li>
                </ul>
            </div>
...
<!-- CAPABILITIES -->
<section class="why-section" id="capabilities">
    ...
    <div class="container">
        ...
        <div class="section-header fade-in">
            ...
            <h2>BPO &amp; Managed Services Capabilities</h2>

            <p>
                From a single outsourced function to a fully managed back office,
                our team covers the operational work your organization needs to
        ...
        <div class="bento-grid">
            ...
            <div class="card fade-in">
                ...
                <h3>Finance &amp; Accounting Outsourcing</h3>
                <p>
                    We manage bookkeeping, reconciliations, accounts payable and
                    receivable, and financial reporting to a consistent standard.
                </p>
            </div>

            <div class="card fade-in">
                
                <h3>Contact Center &amp; Customer Support</h3>
                <p>
                    We run customer service, helpdesk and support functions on
                    your behalf, without the overhead of building a team in-house.
                </p>
            </div>
            ...
            <div class="card fade-in">
                ...
                <p>
                    We handle payroll processing, employee records and HR
                    administration accurately and on schedule, every cycle.
                </p>
            </div>

            <div class="card fade-in">
                
                <h3>IT Managed Services &amp; Helpdesk</h3>
                <p>
                    We provide ongoing IT support and helpdesk coverage, so issues
                    get resolved without you needing a full in-house IT team.
                </p>
            </div>
            ...
            <div class="card fade-in">
                ...
                <p>
                    We manage data entry, document processing and records
                    management at volume, with quality checks built in.
                </p>
            </div>
            ...
            <div class="card fade-in">
                ...
                <p>
                    We take on the day-to-day administrative work that keeps the
                    business running but doesn't need to sit on your desk.
                </p>
            </div>
...
<section class="service-cta">
    <h2>Ready to Offload the Work That's Not Core to Your Business?</h2>
    <p>
        Tell us which function is taking up the most time and headcount —
        we'll show you what running it as a managed service could look like.
    </p>
    <div class="btns">
        <a href="index.php#contact" class="btn-gold">Discuss Your Outsourcing Needs</a>
    </div>
</section>
